<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlterDriver.aspx.cs" Inherits="Logistics.Driver.AlterDriver" %>
        ...
        <fieldset style="margin-left: auto; margin-right: auto; text-align: left; width: 734px">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:TextBox ID="txtBirth" runat="server" Height="23px" Width="150px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>身份证号码：</td>
                    <td>
                        <asp:TextBox ID="txtCarID" runat="server" Width="150px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:RadioButtonList ID="rblstate" runat="server" BorderStyle="None" RepeatDirection="Horizontal" Width="192px">
                            ...
                            <asp:ListItem Value="2">空闲中</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td colspan="2" style="text-align:right">
                        <asp:Button ID="AddDriver" runat="server" Text="添加" OnClick="Button1_Click" Visible="false" />
                        <asp:Button ID="UpdateDriver" runat="server" OnClick="Button1_Click" Text="修改"  Visible="false"/>
                        &nbsp;
